...
//| Report generation                                                |
//+------------------------------------------------------------------+
MTAPIRES CDepositWithdrawal::Generate(const uint32_t type,IMTReportAPI *api)
  {
...
//+------------------------------------------------------------------+
MTAPIRES CDepositWithdrawal::TableWrite(const uint64_t login)
  {
   IMTDeal     *deal=NULL;
...
//| Sort summary                                                     |
//+------------------------------------------------------------------+
int32_t CDepositWithdrawal::SortSummary(const void *left,const void *right)
  {
