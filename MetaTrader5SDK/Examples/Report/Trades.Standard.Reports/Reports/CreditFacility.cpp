...
//+------------------------------------------------------------------+
#include "stdafx.h"
#include "CreditFacility.h"
//+------------------------------------------------------------------+
//| Plug-in description structure                                    |
//+------------------------------------------------------------------+
MTReportInfo CCreditFacility::s_info=
  {
   100,
   MTReportAPIVersion,
   0,
...
//| Column descriptions                                              |
//+------------------------------------------------------------------+
ReportColumn CCreditFacility::s_columns[]=
  {
   ...
   { COLUMN_TIME,            L"Time",          IMTDatasetColumn::TYPE_DATETIME,  15, 150, offsetof(TableRecord,time_create),     0,                                 0,                      0                             },
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CCreditFacility::CCreditFacility(void) : m_api(NULL),m_deals(NULL),m_user(NULL),m_group(NULL)
  {
  }
//+------------------------------------------------------------------+
//| Destructor                                                       |
//+------------------------------------------------------------------+
CCreditFacility::~CCreditFacility(void)
  {
   Clear();
  }
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
void CCreditFacility::Info(MTReportInfo& info)
  {
...
//| Release plug-in                                                  |
//+------------------------------------------------------------------+
void CCreditFacility::Release(void)
  {
   delete this;
  }
//+------------------------------------------------------------------+
//| Report generation                                                |
//+------------------------------------------------------------------+
MTAPIRES CCreditFacility::Generate(const uint32_t type,IMTReportAPI *api)
  {
...
//| Cleanup                                                          |
//+------------------------------------------------------------------+
void CCreditFacility::Clear(void)
  {
...
//+------------------------------------------------------------------+
MTAPIRES CCreditFacility::TablePrepare(void)
  {
...
//| Write table                                                      |
//+------------------------------------------------------------------+
MTAPIRES CCreditFacility::TableWrite(const uint64_t login)
  {
   ...
   for(i=0,deal_total=m_deals->Total();i<deal_total;i++)
     {
      ...
      if((deal=m_deals->Next(i))==NULL)
         continue;
      //--- is credit?
      if(deal->Action()==IMTDeal::DEAL_CREDIT || deal->Action()==IMTDeal::DEAL_SO_COMPENSATION_CREDIT)
        {
         //--- clear record
...
//| Write summary                                                    |
//+------------------------------------------------------------------+
MTAPIRES CCreditFacility::TableWriteSummaries(void)
  {
...
//| Sort summary                                                     |
//+------------------------------------------------------------------+
int32_t CCreditFacility::SortSummary(const void *left,const void *right)
  {
