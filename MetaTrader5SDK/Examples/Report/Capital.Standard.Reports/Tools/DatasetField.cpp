...
//+------------------------------------------------------------------+
MTAPIRES CDatasetRequest::FieldSetBetweenInt(const int64_t from,const int64_t to)
  {
//--- check
   if(from>to)
      return(MT_RET_ERR_PARAMS);
...
//+------------------------------------------------------------------+
MTAPIRES CDatasetRequest::FieldSetBetweenUInt(const uint64_t from,const uint64_t to)
  {
//--- check
   if(from>to)
      return(MT_RET_ERR_PARAMS);
