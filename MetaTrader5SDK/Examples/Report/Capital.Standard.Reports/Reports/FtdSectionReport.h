...
//+------------------------------------------------------------------+
class CFtdSectionReport : public CCurrencyReport, public IClientFtdReceiver
  {
private:
   //--- constants
   enum EnConstants
...
private:
   ...
   CFtdSection       m_section_value;              // FTD by value
   //--- static data
   static MTReportInfo s_info;                     // static report info

public:
   //--- constructor/destructor
                     CFtdSectionReport(void);
   virtual          ~CFtdSectionReport(void);
   //--- report information
