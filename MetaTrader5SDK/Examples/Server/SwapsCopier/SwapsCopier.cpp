...
MTPluginParam ExtPluginDefaults[]=
  {
     { MTPluginParam::TYPE_STRING, L"Server Address",   L""                },
   { MTPluginParam::TYPE_INT,    L"Manager Login",    L""                },
   { MTPluginParam::TYPE_STRING, L"Manager Password", L""                },
   { MTPluginParam::TYPE_STRING, L"Symbols",          L"Forex\\Major\\*" }
  };
//+------------------------------------------------------------------+
//| DLL Main function                                                |
//+------------------------------------------------------------------+
