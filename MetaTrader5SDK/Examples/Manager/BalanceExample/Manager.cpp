...
//--- create deal array
   if(!(m_deal_array=m_manager->DealCreateArray()))
     {
      m_manager->LoggerOutString(MTLogErr,L"DealCreateArray fail");
...
//--- create user interface
   if(!(m_user=m_manager->UserCreate()))
     {
      m_manager->LoggerOutString(MTLogErr,L"UserCreate fail");
...
//--- create account interface
   if(!(m_account=m_manager->UserCreateAccount()))
     {
      m_manager->LoggerOutString(MTLogErr,L"UserCreateAccount fail");
...
//| Login                                                            |
//+------------------------------------------------------------------+
bool CManager::Login(LPCWSTR server,uint64_t login,LPCWSTR password)
  {
//--- connect
...
//+------------------------------------------------------------------+
bool CManager::GetUserDeal(IMTDealArray*& deals,const uint64_t login,SYSTEMTIME &time_from,SYSTEMTIME &time_to)
  {
//--- request array
...
//+------------------------------------------------------------------+
bool CManager::GetUserInfo(uint64_t login,CMTStr &str)
  {
...
//| Get user info string                                             |
//+------------------------------------------------------------------+
bool CManager::GetAccountInfo(uint64_t login,CMTStr &str)
  {
...
//| Dealer operation                                                 |
//+------------------------------------------------------------------+
bool CManager::DealerBalance(const uint64_t login,const double amount,const uint32_t type,const LPCWSTR comment,bool deposit)
  {
   uint64_t deal_id=0;
//--- dealer operation
