...
//|                                                                  |
//+------------------------------------------------------------------+
BOOL CBalanceExampleDlg::OnInitDialog(void)
  {
...
//--- initialize combo box operation
   int32_t idx=m_Operation.AddString(L"Balance");
...
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnPaint(void)
  {
   if(IsIconic())
     {
...
//|                                                                  |
//+------------------------------------------------------------------+
HCURSOR CBalanceExampleDlg::OnQueryDragIcon(void)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnBnClickedLogin(void)
  {
   wchar_t login[64];
   wchar_t password[64];
   wchar_t server[64];
...
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnBnClickedLogout(void)
  {
   m_manager.Logout();
//--- disable controls
   EnableControls(FALSE);
...
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnBnClickedGetUser(void)
  {
   CMTStr1024 str;
   wchar_t    user[64];
   uint64_t     login;
...
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnBnClickedButtonWithdrawal(void)
  {
   wchar_t tmp[256]=L"";
   uint64_t  login;
   double  amount;
...
//---
   ...
   amount=_wtof(tmp);
   type  =(uint32_t)m_Operation.GetItemData(m_Operation.GetCurSel());
...
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnBnClickedButtonDeposit(void)
  {
   wchar_t tmp[256]=L"";
   uint64_t  login;
   double  amount;
...
//+------------------------------------------------------------------+
void CBalanceExampleDlg::UpdateButtons(void)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnEnChangeEditComment(void)
  {
   UpdateButtons();
  }
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnEnChangeEditAmount(void)
  {
   UpdateButtons();
  }
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
void CBalanceExampleDlg::OnBnClickedButtonGetdeals(void)
  {
...
//--- for all deal in array
   for(uint32_t i=0;i<deal_array->Total();i++)
     {
      //--- get deal
