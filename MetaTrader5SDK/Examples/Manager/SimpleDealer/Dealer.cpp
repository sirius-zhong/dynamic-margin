...
//--- save authorize info
   m_login=login;
   wcsncpy_s(m_server,_countof(m_server),server,_TRUNCATE);
   wcsncpy_s(m_password,_countof(m_password),password,_TRUNCATE);
...
//|                                                                  |
//+------------------------------------------------------------------+
void CDealer::OnUserLogin(LPCWSTR ip,const IMTUser* user,const uint32_t type)
  {
   if(user)
...
//|                                                                  |
//+------------------------------------------------------------------+
void CDealer::OnUserLogout(LPCWSTR ip,const IMTUser* user,const uint32_t type)
  {
   if(user)
