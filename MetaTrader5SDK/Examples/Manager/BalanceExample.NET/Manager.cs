      ...
      public bool Initialize()
        {
         ...
         if((m_deal_array=m_manager.DealCreateArray())==null)
           {
            m_manager.LoggerOutString(EnMTLogCode.MTLogErr,"DealCreateArray fail");
         ...
         if((m_user=m_manager.UserCreate())==null)
           {
            m_manager.LoggerOutString(EnMTLogCode.MTLogErr,"UserCreate fail");
         ...
         if((m_account=m_manager.UserCreateAccount())==null)
           {
            m_manager.LoggerOutString(EnMTLogCode.MTLogErr,"UserCreateAccount fail");
