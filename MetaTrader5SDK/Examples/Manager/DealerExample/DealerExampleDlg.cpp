...
//|                                                                  |
//+------------------------------------------------------------------+
CDealerExampleDlg::~CDealerExampleDlg(void)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
BOOL CDealerExampleDlg::OnInitDialog(void)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
void CDealerExampleDlg::OnPaint(void)
  {
   if(IsIconic())
     {
...
//|                                                                  |
//+------------------------------------------------------------------+
HCURSOR CDealerExampleDlg::OnQueryDragIcon(void)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
void CDealerExampleDlg::OnBnClickedLogin(void)
  {
   CString login;
   CString password;
   CString server;
...
//|                                                                  |
//+------------------------------------------------------------------+
void CDealerExampleDlg::OnBnClickedLogout(void)
  {
   m_dealer.Stop();
//--- update buttons
...
//|                                                                  |
//+------------------------------------------------------------------+
void CDealerExampleDlg::OnBnClickedConfirm(void)
  {
//--- confirm request
...
//|                                                                  |
//+------------------------------------------------------------------+
void CDealerExampleDlg::OnBnClickedReject(void)
  {
//--- reject request
