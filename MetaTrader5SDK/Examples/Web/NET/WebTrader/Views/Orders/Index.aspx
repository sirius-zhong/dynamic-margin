...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Orders</asp:Content>
...
<%
    if(Model.CurrentPage > 1 || count >= OrdersController.ORDERS_PAGE)
          {
%>
<div style="padding: 10px 0 5px 0;">
         <span class="paginator">Page: <% 
                ...
                new Paginator
                {
                    PageCount = count >= OrdersController.ORDERS_PAGE ? Model.CurrentPage + 1 : Model.CurrentPage,
