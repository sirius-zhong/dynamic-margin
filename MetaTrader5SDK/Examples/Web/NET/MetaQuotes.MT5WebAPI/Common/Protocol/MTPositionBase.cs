...
namespace MetaQuotes.MT5WebAPI.Common.Protocol
  ...
  class MTPositionBase : MTAPIBase
    ...
    private static MTRetCode ParsePositionTotal(string answer,out uint total)
      ...
      //---
      MTPositionTotalAnswer groupAnswer = new MTPositionTotalAnswer();
      //--- get param
      int posEnd = -1;
      MTAnswerParam param;
    ...
    private static MTRetCode ParsePositionPage(string command,string answer,out List<MTPosition> positions)
      ...
      //---
      MTPositionPageAnswer positionAnswer = new MTPositionPageAnswer();
      //--- get param
      int posEnd = -1;
      MTAnswerParam param;
      while((param = MTParseProtocol.GetNextParam(answer,ref pos,ref posEnd)) != null)
    ...
    private static MTRetCode ParsePosition(string command,string answer,out MTPosition position)
      ...
      //---
      MTPositionAnswer positionAnswer = new MTPositionAnswer();
      //--- get param
      int posEnd = -1;
      MTAnswerParam param;
      while((param = MTParseProtocol.GetNextParam(answer,ref pos,ref posEnd)) != null)
  ...
  internal class MTPositionAnswer : MTBaseAnswerJson
    ...
    public MTPosition GetFromJson()
      ...
      try
        ...
        serializer.RegisterConverters(new List<JavaScriptConverter> { new MTPositionConverter() });
        return serializer.Deserialize<MTPosition>(ConfigJson);
        }
      catch(Exception e)
        {
  ...
  internal class MTPositionPageAnswer : MTBaseAnswerJson
    ...
    public List<MTPosition> GetFromJson()
      ...
      try
        {
        JavaScriptSerializer serializer = new JavaScriptSerializer { MaxJsonLength = MAX_LENGHT_JSON };
        serializer.RegisterConverters(new List<JavaScriptConverter> { new MTPositionPageConverter() });
        return serializer.Deserialize<List<MTPosition>>(ConfigJson);
        }
      catch(Exception e)
        {
  ...
  /// </summary>
  internal class MTPositionPageConverter : JavaScriptConverter
    {
    ...
    public override object Deserialize(IDictionary<string,object> dictionary,Type type,JavaScriptSerializer serializer)
      ...
      //---
      return MTPositionConverter.ParsePosition(dictionary);
      }
  ...
  /// </summary>
  internal class MTPositionConverter : JavaScriptConverter
    {
    private static readonly Type[] m_SupportedTypes = new[] { typeof(MTPosition) };
    public override IEnumerable<Type> SupportedTypes { get { return m_SupportedTypes; } }
    /// <summary>
    ...
    public override object Deserialize(IDictionary<string,object> dictionary,Type type,JavaScriptSerializer serializer)
      ...
      if(dictionary == null) return null;
      //---
      return ParsePosition(dictionary);
      }
    /// <summary>
    /// Parsing
    /// </summary>
