...
namespace MetaQuotes.MT5WebAPI.Common.Protocol
  ...
  class MTSymbolBase :MTAPIBase
    ...
    public MTRetCode SymbolNext(int pos,out MTConSymbol conSymbol)
      ...
      conSymbol = null;
      //--- send request
      Dictionary<string,string> data = new Dictionary<string,string> { { MTProtocolConsts.WEB_PARAM_INDEX,pos.ToString() } };
      //--- get answer
      byte[] answer;
      //--- send request
    ...
    public MTRetCode SymbolGet(string name,out MTConSymbol conSymbol)
      ...
      conSymbol = null;
      //--- send request
      Dictionary<string,string> data = new Dictionary<string,string> { { MTProtocolConsts.WEB_PARAM_SYMBOL,name } };
      //--- get answer
      byte[] answer;
      //--- send request
    ...
    public MTRetCode SymbolAdd(MTConSymbol symbol,out MTConSymbol newSymbol)
      ...
      newSymbol = null;
      //--- send request
      Dictionary<string,string> data = new Dictionary<string,string> { { MTProtocolConsts.WEB_PARAM_BODYTEXT,MTSymbolJson.ToJson(symbol) } };
      //--- get answer
      byte[] answer;
      //--- send request
    ...
    private static MTRetCode ParseSymbolTotal(string answer,out int total)
      ...
      //---
      MTSymbolTotalAnswer symbolAnswer = new MTSymbolTotalAnswer();
      //--- get param
      int posEnd = -1;
      MTAnswerParam param;
    ...
    private static MTRetCode ParseSymbol(string command,string answer,out MTConSymbol conSymbol)
      ...
      //---
      MTSymbolAnswer symbolAnswer = new MTSymbolAnswer();
      //--- get param
      int posEnd = -1;
      MTAnswerParam param;
      while((param = MTParseProtocol.GetNextParam(answer,ref pos,ref posEnd)) != null)
  ...
  internal class MTSymbolAnswer :MTBaseAnswerJson
    ...
    public MTConSymbol GetFromJson()
      ...
      try
        ...
        serializer.RegisterConverters(new List<JavaScriptConverter> { new MTConSymbolConverter() });
        return serializer.Deserialize<MTConSymbol>(ConfigJson);
        }
      catch(Exception e)
        {
  ...
  /// </summary>
  internal class MTConSymbolConverter :JavaScriptConverter
    {
    private static readonly Type[] m_SupportedTypes = new[] { typeof(MTConSymbol) };
    ...
    public override object Deserialize(IDictionary<string,object> dictionary,Type type,JavaScriptSerializer serializer)
      ...
      return ParseSymbol((Dictionary<string,object>)dictionary);
      }
    /// <summary>
    /// parsing one symbol
    /// </summary>
    ...
    public static MTConSymbol ParseSymbol(Dictionary<string,object> symbol)
      ...
      MTConSymbol conSymbol = new MTConSymbol();
      //---
    ...
    private static Dictionary<MTConSymbol.EnMarginRateTypes,double> MarginRateMaintenance(Dictionary<string,object> symbol)
      {
      Dictionary<MTConSymbol.EnMarginRateTypes,double> result = new Dictionary<MTConSymbol.EnMarginRateTypes,double>{
    ...
    private static List<List<MTConSymbolSession>> ParsingSessions(ArrayList sessions)
      ...
      //---
      List<List<MTConSymbolSession>> result = new List<List<MTConSymbolSession>>();
      //---
    ...
    private static List<MTConSymbolSession> ParsingSession(ArrayList sessions)
      ...
      if(sessions == null) return null;
      //---
      List<MTConSymbolSession> result = new List<MTConSymbolSession>();
      //---
      foreach(object sessionInfo in sessions)
        {
    ...
    private static MTConSymbolSession ParsingSession(Dictionary<string,object> dictionary)
      ...
      if(dictionary == null) return null;
      //---
      MTConSymbolSession obj = new MTConSymbolSession();
      //---
    ...
    public static MTConGroupSymbol ParseGroupSymbol(Dictionary<string,object> groupSymbol)
      ...
      MTConGroupSymbol conSymbol = new MTConGroupSymbol();
      //---
